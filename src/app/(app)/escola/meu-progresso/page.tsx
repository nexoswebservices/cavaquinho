  ...
  return (
    <div>
      ...
      <div className="space-y-10">
        ...
        {!userId && (
          <div className="bg-[#120d24] border border-violet-500/20 rounded-2xl p-5 text-center">
            <p className="text-slate-400 text-sm mb-3">Faça login para acompanhar seu progresso.</p>
            <Link
              href="/login"
              className="inline-block bg-violet-600 hover:bg-violet-500 text-white font-semibold px-5 py-2.5 rounded-xl text-sm transition-colors"
            >
              Entrar
            </Link>
          </div>
